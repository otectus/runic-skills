# Integration & Lock-Provider Matrix (1.3.8)
...
| Provider id | Namespace(s) | Wiring | Installed in Lorecraft | Base/approach |
| --- | --- | --- | --- | --- |
...
| bloodmagic | bloodmagic | curated adapter | ❌ | curated (active if present) |
...
| epic_knights | magistuarmory, magistuarmoryaddon, darkagesarmory, epic_knights__japanese_armory, epic_knights_ice_and_fire | discovered | ✅ | base 12 |
...
| enigmaticlegacy | enigmaticlegacy | discovered | ❌ | base 16 |
...
Attributes, Botania, Cataclysm/Mowzie's/Farmers Delight (combat-event perks), the gun mods (TacZ, CGM,
