> **Historical document — Configuration-reliability audit — 1.3.7 (10 June 2026)**
>
> This is a point-in-time record of the configuration-reliability audit run against **1.3.7**, kept for provenance. It is **not** a description of the mod as it ships today: much of what it reports was fixed in 1.5.0, 1.7.0, 1.9.0 and 2.0.0, and at least one row (the Botania integration TODO) describes an integration that was deleted in 1.5.0.
>
> For the current picture see [`docs/RUNIC_SKILLS_AUDIT.md`](../RUNIC_SKILLS_AUDIT.md) and the 2.0.0 entry in [`CHANGELOG.md`](../../CHANGELOG.md).
