> **Historical document — Magic-tree design research — pre-1.0 (April 2026)**
>
> Pre-implementation research for the magic perk tree, kept for provenance. It is a **proposal**, not a description of anything that shipped: roughly seventy perk designs here were never built in this form, and its opening note asserting that no Runic Skills project exists on CurseForge or Modrinth was already obsolete when the mod was published.
>
> What the magic tree actually does is in [`docs/PERK_AUDIT.md`](../PERK_AUDIT.md).
