> **Historical document — Verification run — 1.3.7 (June 2026)**
>
> A point-in-time verification transcript for **1.3.7**, kept for provenance. Its expectations are stale by design: it predicts ten `ConfigHolderTest` cases against a suite that now has thirty-three test classes, and it names a YACL version three releases behind the pin.
>
> The living runtime checklist is [`docs/SMOKE_TESTS.md`](../SMOKE_TESTS.md).
