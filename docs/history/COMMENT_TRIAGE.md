> **Historical document — User-report triage — through 1.3.7 (June 2026)**
>
> Triage of player reports up to **1.3.7**, kept for provenance. Nothing from 1.5.0 onward was ever added, so its absence of recent entries means the file stopped being maintained, not that no reports arrived.
