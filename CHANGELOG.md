...
- Fixed `Utils.intToRoman` (was duplicating the thousands array and missing the units array — `1994` now correctly produces `MCMXCIV`). Added a JUnit 5 regression test under `src/test/java/`.
...
- Added JUnit 5 test source set to `build.gradle`.
