...
public class RegistryPowers {
     ...
     * you read the name. The shipped set is checked-in art, pinned by
     * {@code tools/icongen/catalogue.json}, so tier and school in the art cannot drift from tier and
     * school in the code, and {@code PowerIconCoverageTest} fails the build if one goes missing.
     */
